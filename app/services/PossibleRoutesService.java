...
@Service
public class PossibleRoutesService {
    ...
    public SearchResponse createRoutes(SearchParameters searchParameters) {
        ...
        try {
            ...
            if (response.getStatus()) {
                AirSolution airSolution = getAirSolution(response, searchParameters);
                searchResponse = new SearchResponse();
    ...
    public AirSolution getAirSolution(TravelomatrixSearchReply response, SearchParameters searchParameters) {
