...
public class AirMessageQueue {
    ...
    public AirRemoveMessageQueueRS removeMessageQueueRQ() throws RemoteException{
        SessionsHandler sessionsHandler = new SessionsHandler();
        OnePointStub onePointStub = sessionsHandler.getOnePointStub();
        String sessionId = sessionsHandler.mystiflySessionHandler();
        ...
        item.setUniqueId("MF00221316");
        arrayOfItem.setItemArray(0,item);
        airRemoveMessageQueueRQ.setSessionId(sessionId);
